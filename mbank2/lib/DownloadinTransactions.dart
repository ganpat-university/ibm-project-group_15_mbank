...
void main() {
  ...
  pdf.addPage(MultiPage(
      pageFormat: PdfPageFormat.letter.copyWith(marginBottom: 1.5 * PdfPageFormat.cm), crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Page page = new Page();
  page.generate(pdf);
  file.writeAsBytesSync([123,4345,565,434,34,65,6767,67,68,79,789,]);
}